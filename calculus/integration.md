...
Нет удобной формулы наподобие $(uv)' = u'v + v'u$. Зато есть такая -- формула интегрирования по частям собственной персоной

$$\int_{}^{} udv = uv - \int_{}^{} vdu$$

По частям берутся интегралы следующих видов:

1. $\int_{}^{} ln(x)dx$, $\int_{}^{} (x^2 + 3)ln(x)dx$, $\int_{}^{} xln^2(x)dx$ - логарифм, логарифм, умноженный на какой-нибудь многочлен.
