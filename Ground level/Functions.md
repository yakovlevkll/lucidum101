...
В математике функции записывают с помощью букв <![if !msEquation]>  <![endif]> или <![if !msEquation]>  <![endif]>. Для того чтобы отличить функцию от обычной величины, после имени функции обычно пишут переменные, от которых она зависит. Например, функция $f$, которая зависит от <![if !msEquation]>  <![endif]> и <![if !msEquation]>  <![endif]> будет записана следующим образом
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI4NTk3NTUzLC0xMzgzMjI3MTM1XX0=
-->