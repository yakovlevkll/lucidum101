...
$c$  -- (y-intercept) – коэффициент, отвечающий за положение графика по оси $y$. Численно равен <![if !msEquation]>  <![endif]>-координате пересечения с осью <![if !msEquation]>  <![endif]>. В функциях, которые мы будем разбирать позже, мы также встретим этот коэффициентом, и в каждой из них он отвечает за одно и то же.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzI0NDM4OTksLTEzODMyMjcxMzVdfQ
==
-->