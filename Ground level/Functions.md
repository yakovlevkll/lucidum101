...
$m$ – коэффициент, отвечающий за скорость подъема прямой. Это влияет на угол наклона этой прямой по отношению к оси $x$. В дальнейшем мы узнаем, что $m$ численно равен тангенсу угла между прямой и осью $x$. Буква <![if !msEquation]>  <![endif]> выбрана не просто так – позже мы узнаем, что данное число также является градиентом.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcxMDI3Nzk3LC0xMzgzMjI3MTM1XX0=
-->